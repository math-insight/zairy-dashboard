import { hexToRgb, mixColor, rgbToHex } from "../utils/colorParsers.ts";
import ColorThresholds from "../types/ColorThresholds.ts";

export default function getColorForValue( measuredValue: number, colorThresholds: ColorThresholds[] ) {
