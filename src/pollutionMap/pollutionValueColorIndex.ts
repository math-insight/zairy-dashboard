// source https://powietrze.gios.gov.pl/pjp/content/show/1001197

import PollutionValueColorIndex from "../types/PollutionValueColorIndex.ts";

const PollutionsValueColorIndexes: PollutionValueColorIndex[] = [
    {
        name: 'CO',
        unit: 'mg/m3',
        colorThresholds: [
...
export default PollutionsValueColorIndexes;
